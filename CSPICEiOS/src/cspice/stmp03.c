	...
	doublereal *c2, doublereal *c3)
{
    ...
    static doublereal pairs[STMP03_ARRAY_SIZE], lbound;
...
/*     some large power of 2 (say 2**20). */
    ...
    if (first) {
	first = FALSE_;
	for (i__ = 1; i__ <= STMP03_ARRAY_SIZE; ++i__) {
	    pairs[(i__1 = i__ - 1) < STMP03_ARRAY_SIZE && 0 <= i__1 ? i__1 : s_rnge("pairs", 
...
/*     LPAIR3 will be 18. */
    ...
    *c3 = 1.;
    for (i__ = STMP03_ARRAY_SIZE; i__ >= 4; i__ += -2) {
	*c3 = 1. - y * pairs[(i__1 = i__ - 1) < STMP03_ARRAY_SIZE && 0 <= i__1 ? i__1 : 
...
/*     LPAIR2 will be 17. */
    ...
    *c2 = 1.;
    for (i__ = (STMP03_ARRAY_SIZE - 1); i__ >= 3; i__ += -2) {
	*c2 = 1. - y * pairs[(i__1 = i__ - 1) < STMP03_ARRAY_SIZE && 0 <= i__1 ? i__1 : 
