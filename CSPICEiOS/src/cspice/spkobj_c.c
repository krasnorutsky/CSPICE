...
void summarizeLoadedData(const char* filename, void* owner, void(*callb)(void*,int,const char*,double,double))
{
#define  FILSIZ         256
#define  MAXIV          1000
#define  WINSIZ         ( 2 * MAXIV )
