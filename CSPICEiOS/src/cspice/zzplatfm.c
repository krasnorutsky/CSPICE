...
/*        Platform/Environment specific assignments follow. */
	...
	s_copy(attcpy + 32, CSPICE_SPECIFIC_ASSIGNMENT_STRING2, (ftnlen)32, (ftnlen)9);
	s_copy(attcpy + 64, "MAC OS-X", (ftnlen)32, (ftnlen)8);
	s_copy(attcpy + 96, CSPICE_SPECIFIC_ASSIGNMENT_STRING, (ftnlen)32, (ftnlen)2);
	s_copy(attcpy + 128, CSPICE_SPECIFIC_ASSIGNMENT_STRING3, (ftnlen)32, (ftnlen)8);
...
/*     returns a value of zero. */
    ...
    s_copy(value, attcpy + (((i__1 = index) < 7 && 0 <= i__1 ? i__1 : s_rnge(
	    "attcpy", i__1, "zzplatfm_", (ftnlen)CSPICE_SPECIFIC_IDENTIFIER_CODE)) << 5), value_len, (
	    ftnlen)32);
    return 0;
} /* zzplatfm_ */
